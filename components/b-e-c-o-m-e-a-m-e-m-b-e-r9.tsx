...
import styles from "./b-e-c-o-m-e-a-m-e-m-b-e-r9.module.css";

const BECOMEAMEMBER9: NextPage = () => {
  ...
  return (
    <section className={styles.becomeAMember}>
      ...
      />
      <div className={styles.ifYouHaveAnyQuestionsWeAParent}>
        <h1 className={styles.ifYouHave}>
          If You Have Any Questions We Are Here!!
        </h1>
        <div className={styles.thaneCorelSquare022258Wrapper}>
      ...
      <div className={styles.ourBranches}>
        <div className={styles.rectangleParent}>
          ...
          <div className={styles.onlineAppointment} onClick={onRectangleClick} >ONLINE APPOINTMENT</div>
        </div>
      </div>
    </section>
  );
