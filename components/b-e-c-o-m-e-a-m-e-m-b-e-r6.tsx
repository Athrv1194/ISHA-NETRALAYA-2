...
import styles from "./b-e-c-o-m-e-a-m-e-m-b-e-r6.module.css";

const BECOMEAMEMBER6: NextPage = () => {
  const router = useRouter();

  const onMenuItemsTextClick = useCallback(() => {
  ...
  return (
    <section className={styles.becomeAMember}>
      ...
      />
      <div className={styles.contactTextData}>
        <h1 className={styles.ifYouHave}>
          If You Have Any Questions We Are Here!!
        </h1>
        <div className={styles.corneaCardsData}>
      ...
      <div className={styles.cataractData}>
        <div className={styles.branchesInfo}>
          <div
            className={styles.menuItemsText}
            onClick={onMenuItemsTextClick}
          />
