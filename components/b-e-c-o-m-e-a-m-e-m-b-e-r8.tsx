...
import styles from "./b-e-c-o-m-e-a-m-e-m-b-e-r8.module.css";

const BECOMEAMEMBER8: NextPage = () => {
  return (
    <section className={styles.becomeAMember}>
      ...
      <div className={styles.branchHeader}>
        ...
        <div className={styles.thaneCorelSquareFrame}>
      ...
      <div className={styles.branchDetailsContentFrameWrapper}>
        <div className={styles.branchDetailsContentFrame}>
          <div className={styles.branchInfoText} />
          <h3 className={styles.onlineAppointment}>ONLINE APPOINTMENT</h3>
        </div>
      </div>
    </section>
  );
