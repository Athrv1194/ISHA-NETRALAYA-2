  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.textStyles}>
        ...
        <div className={styles.framePropertes}>
          ...
          <div className={styles.textFrameProperties}>
          ...
          <div className={styles.textFrameProperties1}>
      ...
      <div className={styles.designExplorer}>
        <div className={styles.assetsLibrary}>
      ...
      <div className={styles.textManipulator}>
        <div className={styles.geometryHandler}>
