...
import styles from "./subtitle-text.module.css";

const SubtitleText: NextPage = () => {
  return (
    <section className={styles.subtitleText}>
      <div className={styles.callToActionLabel}>
        <div className={styles.footerMenuLinkset}>
        ...
        <div className={styles.cornealCardContainer}>
          <div className={styles.glaucomaCardContainer}>
            <div className={styles.cataractCardContainer}>
          ...
          <div className={styles.headingTextZone}>
