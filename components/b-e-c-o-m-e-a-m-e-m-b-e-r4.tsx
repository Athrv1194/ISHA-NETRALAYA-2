...
import styles from "./b-e-c-o-m-e-a-m-e-m-b-e-r4.module.css";

const BECOMEAMEMBER4: NextPage = () => {
  const router = useRouter();

  const onOurServicesSectionClick = useCallback(() => {
  ...
  return (
    <section className={styles.becomeAMember}>
      ...
      <div className={styles.onlineAppointment}>
        ...
        <div className={styles.thaneBranchDetails}>
      ...
      <div className={styles.puneBranchDetails}>
        <div className={styles.homeFrame}>
          <div
            className={styles.ourServicesSection}
            onClick={onOurServicesSectionClick}
          />
          <h3 className={styles.onlineAppointment1}>ONLINE APPOINTMENT</h3>
        </div>
      </div>
    </section>
  );
