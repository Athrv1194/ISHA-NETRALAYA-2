...
const Footer7: NextPage = () => {
  return (
    <footer className={styles.footer}>
      <div className={styles.footerChild} />
      <div className={styles.ourBranches}>Our Branches</div>
      <div className={styles.actionStylesetData}>
        <div className={styles.infoTextContainerText}>
        ...
        <div className={styles.primaryTextDataText}>
          ...
          <div className={styles.secondaryTextDataText}>
          ...
          <div className={styles.secondaryTextDataText1}>
      ...
      <div className={styles.additionalInfotextData}>
        <div className={styles.contactTextDatatext}>
          <div className={styles.servicesDatatext}>
          ...
          <div className={styles.glaucomaDatatext}>
            <div className={styles.cataractDatatext}>
              <div className={styles.locationsDatatext}>
                <div className={styles.ourServices}>Our Services</div>
              </div>
              <div className={styles.brandLinksetText}>
      ...
      <div className={styles.infotextData}>
        <div className={styles.backdroplinkdatatext}>
        ...
        <div className={styles.cTALabeltextDatatext}>
