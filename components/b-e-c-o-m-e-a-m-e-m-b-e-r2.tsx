...
import styles from "./b-e-c-o-m-e-a-m-e-m-b-e-r2.module.css";

const BECOMEAMEMBER2: NextPage = () => {
  const router = useRouter();

  const onErrorNodesClick = useCallback(() => {
  ...
  return (
    <section className={styles.becomeAMember}>
      ...
      <div className={styles.operationNodes}>
        <div className={styles.eventNodes}>
          <div className={styles.errorNodes} onClick={onErrorNodesClick} />
