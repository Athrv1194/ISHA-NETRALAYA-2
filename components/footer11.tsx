  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.ambernathBranch}>
        ...
        <div className={styles.thaneCoralSquareText}>
      ...
      <div className={styles.contactUsFrameParent}>
          ...
          <div className={styles.cataractLASIK}>
            <div className={styles.sMILESurgery}>
              ...
              <div className={styles.cataractTreatmentParent}>
                ...
                <div className={styles.retinaTreatment1}>
                  <p className={styles.retinaTreatment2}>Retina Treatment</p>
                </div>
              </div>
            </div>
          </div>
