...
import styles from "./footer12.module.css";

const Footer12: NextPage = () => {
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.branchDetails}>
          ...
          <div className={styles.ambernathBranch1}>
      ...
      <div className={styles.ishaNetralayaParent}>
        <div className={styles.ishaNetralaya}>
          <div className={styles.ishaNetralaya1}>ISHA NETRALAYA</div>
