...
import styles from "./footer9.module.css";

const Footer9: NextPage = () => {
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.frameParent}>
        ...
        <div className={styles.thaneCoralSquareIcoralParent}>
          ...
          <div className={styles.branchDetailsContentText}>
          ...
          <div className={styles.branchDetailsContentText1}>
      ...
      <div className={styles.copyrightInfoText}>
        <div className={styles.homeContent}>
          ...
          <div className={styles.footerInfo}>
            <div className={styles.kalyanBranch}>
