...
import styles from "./b-e-c-o-m-e-a-m-e-m-b-e-r1.module.css";

const BECOMEAMEMBER1: NextPage = () => {
  const router = useRouter();

  const onVectorGraphicClick = useCallback(() => {
    ...
    <section className={styles.becomeAMember}>
      ...
      <div className={styles.gradient}>
        <div className={styles.rasterImage}>
          <div
            className={styles.vectorGraphic}
            onClick={onVectorGraphicClick}
          />
