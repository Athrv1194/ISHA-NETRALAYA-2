...
const Footer: NextPage = () => {
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.foodAndLanguage}>
        ...
        <div className={styles.puneBranch}>
          ...
          <div className={styles.thaneCoralSquare1}>
          ...
          <div className={styles.thaneCoralSquare2}>
      ...
      <div className={styles.servicesFrame}>
        <div className={styles.aboutUsFrame}>
          <div className={styles.ishaNetralayaFrame}>
          ...
          <div className={styles.maskGroupFrame}>
            <div className={styles.homeLatestUpdates}>
              ...
              <div className={styles.smileSurgery}>
                ...
                <div className={styles.smileSurgery1}>SMILE Surgery</div>
      ...
      <div className={styles.ishaNetralayaTitle}>
